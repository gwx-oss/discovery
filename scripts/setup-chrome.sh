...
apt-get install -y wget unzip xvfb libappindicator1 fonts-liberation xdg-utils libnss3 libnspr4 libappindicator3-1 libxss1 libasound2 libx11-xcb1 libminizip1 libwebpmux2 libgtk-3-0 >>"$LOG_FILE" 2>&1
